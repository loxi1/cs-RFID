...
{
    public partial class FormReporteLecturaCaja : Form
    {
        ...
        public FormReporteLecturaCaja(FormMain mainForm, string codTrabajador)
        {
            m_MainForm = mainForm;
        ...
        private void BTNBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                /*m_DBReporteLecturaCaja.PruebaConexion();*/
                ldt_reporte_mysql = m_DBReporteLecturaCaja.Reporte(cod_, fec_);
                ...
                foreach (DataGridViewColumn column in dataGridViewReporte.Columns)
                {
                    ...
                    if (column.HeaderText == "cantidad_prendas")
                    {
                        column.HeaderText = "CANTIDAD";
                        dataGridViewReporte.Columns["cantidad_prendas"].ReadOnly = true;
                        dataGridViewReporte.Columns["cantidad_prendas"].DefaultCellStyle.BackColor = Color.WhiteSmoke;
                    }
        ...
        private void FormReporteLecturaCaja_Load(object sender, EventArgs e)
        {
