...
{
    public partial class FormLecturaDeCaja : Form
    {
        ...
        public FormLecturaDeCaja(FormMain mainForm, RFIDReader pReaderAPI, string codTrabajador)
        {
            InitializeComponent();
            m_MainForm = mainForm;
        ...
        private void FormLecturaDeCaja_Load(object sender, EventArgs e)
        {
        ...
        private void FormLecturaDeCaja_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (m_MainForm.m_IsConnected)
            ...
            m_MainForm.m_FormLecturaDeCaja = null;
        }
        ...
        private void FormLecturaDeCaja_Activated(object sender, EventArgs e)
        {
            updateReaderApi();
            updateGPIState();
        }

        private void FormLecturaDeCaja_Resize(object sender, EventArgs e)
        {
            int li_long;
            int li_height;
            int li_width;
        ...
        private void FormLecturaDeCaja_Shown(object sender, EventArgs e)
        {
            if (m_MainForm.m_IsConnected == false)
            {
        ...
        private void MatricularCaja()
        {
            ...
            try
            {
                ...
                Console.WriteLine($" Trabajador-->{m_Cod_Trabajador} Cantidad-->{cantidadEtiquetas} datokey-->{datokeys}");
                m_DBLecturaDeCaja.MatricularCaja(m_Cod_Trabajador, cantidadEtiquetas, datokeys);
            }
            catch (Exception ex)
            {
