...
{
    public partial class FormCajaRotulada : Form
    {
        ...
        public FormCajaRotulada(FormMain mainForm, RFIDReader pReaderAPI, string codTrabajdor)
        {
            InitializeComponent();
            m_MainForm = mainForm;
        ...
        private void FormCajaRotulada_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int index = 0; index < 4; index++)
                {
                    ...
                    //gpiStateLabel.Dock = System.Windows.Forms.DockStyle.Fill;
                    ...
                    gpiStateLabel.Location = new System.Drawing.Point((index * 45), 20);
                    gpiStateLabel.Name = "GPI Estados " + index;
                    gpiStateLabel.Size = new System.Drawing.Size(40, 8);
                    ...
                    gpiStateNumLabel.Font = new System.Drawing.Font(
                        ...
                        ((byte)(0)));
                    gpiStateNumLabel.Location = new System.Drawing.Point(20 + (index * 40), 40);
                    gpiStateNumLabel.Name = "label" + index;
                    gpiStateNumLabel.Size = new System.Drawing.Size(40, 20);
        ...
        private void FormCajaRotulada_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (m_MainForm.m_IsConnected)
            ...
            //m_MainForm.m_FormCajaRotulada = null;
        }
        ...
        private void FormCajaRotulada_Activated(object sender, EventArgs e)
        {
            updateReaderApi();
            updateGPIState();
        }

        private void FormCajaRotulada_Resize(object sender, EventArgs e)
        {
        ...
        private void Uctb_qr_or_br_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                e.SuppressKeyPress = true;
        ...
        private void Uctb_op_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                // Procesa el código escaneado
                string qr = uctb_op.Text;

                Console.WriteLine("Esta leyendo-->123");
                // Limpia el TextBox para el siguiente escaneo
                //ProcessBarcode(qr);

                // Evita que se procese el Enter como un carácter
                e.Handled = true;
            }
        }
        ...
        private void ProcessBarcode(string barcode)
        {
            ...
            MessageBox.Show($"Código escaneado: {barcode}");
        }
