...
{
    public partial class FormReportarIncidente : Form
    {
        ...
        public FormReportarIncidente()
        {
            InitializeComponent();
        }

        private void FormReportarIncidente_Resize(object sender, EventArgs e)
        {
            int li_long;
            int li_height;
            int li_width;
        ...
        private void FormReportarIncidente_Load(object sender, EventArgs e)
        {
        ...
        private void FormReportarIncidente_Resize_1(object sender, EventArgs e)
        {
            int li_long;
            int li_height;
            int li_width;
        ...
        private void FormReportarIncidente_Load_1(object sender, EventArgs e)
        {
            Op_Buscar.Focus();
            Op_Buscar.Text = "";
            Op_Buscar.Enabled = true;
        ...
        private void Op_Buscar_Leave(object sender, EventArgs e)
        {
            Op_Buscar.Focus();
        }
