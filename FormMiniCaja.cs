...
{
    public partial class FormMiniCaja : Form
    {
        ...
        // Usar el Id como valor asociado
        ...
        public FormMiniCaja(FormMain mainForm, RFIDReader pReaderAPI, string codTrabajador)
        {
            InitializeComponent();
            m_MainForm = mainForm;
        ...
        private void FormCajaCantidad_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            m_MainForm.m_FormMiniCaja = null;
        }
        ...
        private void readButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (m_MainForm.m_IsConnected)
                {
                    ...
                    {
                        /*if (int.TryParse(textBoxAsignarTiempo.Text, out tiempoRestante))
                        {
                            labelCronometro.Text = $"{tiempoRestante}";
                            timerCronometro.Start(); // Iniciar el Timer
                        }*/
                        tmP.Start();
                    ...
                    else if (Convert.ToString(readButton.Tag) == "Stop Reading")
                    {
                        ...
                        //timerCronometro.Stop(); // Detener el Timer cuando llega a 0
        ...
        private void FormMiniCaja_Shown(object sender, EventArgs e)
        {
            if (m_MainForm.m_IsConnected == false)
            {
