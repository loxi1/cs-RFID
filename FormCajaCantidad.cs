...
{
    public partial class FormCajaCantidad : Form
    {
        ...
        public FormCajaCantidad(FormMain mainForm, RFIDReader pReaderAPI, string codTrabajdor)
        {
            InitializeComponent();
            m_MainForm = mainForm;
        ...
        private void FormCajaCantidad_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            m_MainForm.m_FormCajaCantidad = null;
        }
